var dict = {
    a: ["Q) What is the Capital of Pakistan ?", "Karachi", "Islamabad", "Rawalpindi"],
    b: ["Q) What is the Capital of Afghanistan ?", "Karachi", "Kabul", "Rawalpindi"],
...
function func(){
    ...
    if (count == 1){
        ...
        alert("Score: " + score)
        document.getElementById("container").innerHTML = `<h2>Score: ${score}</h2><br><button type="button" class="btn" onclick="refresh()">Retake Quiz</button>`;
        return null
    }
